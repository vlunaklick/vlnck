  ...
  return (
    <div className='px-4 flex flex-col gap-3'>
        ...
        <div className="flex gap-5 text-xs sm:text-sm">
            <p className="text-slate-600 dark:text-slate-400 min-w-[10ch]">LinkedIn</p>
        ...
        <div className="flex gap-5 text-xs sm:text-sm">
            <p className="text-slate-600 dark:text-slate-400 min-w-[10ch]">Github</p>
        ...
        <div className="flex gap-5 text-xs sm:text-sm">
            <p className="text-slate-600 dark:text-slate-400 min-w-[10ch]">Resume</p>
