...
const ArticleProject = ({
  ...
  return (
    <article className="transition-colors sm:hover:bg-slate-100 sm:dark:hover:bg-slate-800 sm:p-4 rounded flex sm:flex-row flex-col gap-4 justify-center sm:mt-0 mt-5">
      {/* <a
        href={url}
        target="_blank"
      ...
      <div className="flex flex-col justify-between gap-1">
        ...
        <div className="flex gap-2 first-letter:capitalize text-xs text-slate-800 dark:text-slate-400">
